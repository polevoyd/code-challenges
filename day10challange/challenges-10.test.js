...
//   }, []).reduce( (acc2, curr2) =>
//   {
//     return (curr2 === target) ? acc2 + 1 : acc2;
//   }, 0);
// };



const count = (target, input) => input.reduce((accumulator, current) => accumulator.concat(current), []).reduce( (acc2, curr2) => (curr2 === target) ? acc2 + 1 : acc2, 0);
